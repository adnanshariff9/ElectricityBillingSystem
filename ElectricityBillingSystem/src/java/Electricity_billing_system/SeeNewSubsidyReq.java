 ...
 * @author hp
 */
public class SeeNewSubsidyReq extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            Connection con = dbconnection.getConnectToElectricity_billing_system();
             String sql = "SELECT * FROM users WHERE newSubsidyStatus = 'applied'";
...
out.println("}");
            ...
            out.println("<h2>Users who have applied for a New Subsidy:</h2>");
        out.println("<table ><tr><th>User ID</th><th>Aadhar Card Number</th><th>Email</th><th>Phone</th><th>Address</th><th>Pincode</th><th>Name</th><th>New Subsidy Status</th></tr>");
        ...
        while (resultSet.next()) {
            ...
            out.println("<td>" + resultSet.getString("newSubsidyStatus") + "</td>");

            out.println("<td><form action=\"ApproveSubsidy.jsp\" method=\"post\">");
...
"  </div>");
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(SeeNewSubsidyReq .class.getName()).log(Level.SEVERE, null, ex);
